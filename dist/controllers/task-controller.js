...
class TaskController {
    constructor() {
         ...
         */
        this.getRecommendations = (req, res) => {
            try {
                const { metrics, currentTime, localDate } = req.body;
